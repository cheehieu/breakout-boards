...
All files exported to: C:\UltraLibrarian\Library\Exported\Altium\2015-02-10_01-14-45\2015-02-10_01-14-45
...
Component "DRV8833CPWPR" renamed to "DRV8833CPWPR"


Ultra Librarian Lite 5.3.409 Process Report


Message - Pattern "RTE0016C" contains two pins with the same designator, numbers 18 and 19.
The designator for pin number 19 was changed to "V_2".
Message - Pattern "RTE0016C" contains two pins with the same designator, numbers 20 and 18.
The designator for pin number 18 was changed to "V_3".
Message - Pattern "RTE0016C" contains two pins with the same designator, numbers 21 and 20.
The designator for pin number 20 was changed to "V_4".
